                        ...
                        <div className="inline-block p2 py4">
                            ...
                            <ul>
                                <li className='left-align py2'>
                                    <a href="https://bitcoinclassic.com/devel/Blocksize.html" target="_blank">Bitcoin Classic</a>
                                </li>
                                <li className='left-align py2'>
                                    <Link to="/emergent-consensusBU" target="_blank">Bitcoin Unlimited</Link>
                                </li>
                                <li className='left-align py2'>
                                    <a href="https://github.com/jgarzik/bip100/blob/master/bip-0100.mediawiki" target="_blank">Bitcoin XT</a>
                                </li>
                            </ul>
                            ...
                            <ul>
                                <li className='left-align py2'>
                                    <a className='italic' href="http://www.pbs.org/wgbh/nova/nature/emergence.html" target="_blank">Emergence</a> Nova ScienceNOW
                                </li>
                                <li className='left-align py2'>
                                    <a className='italic' href="https://arxiv.org/pdf/nlin/0506028.pdf" target="_blank">Types and Forms of Emergence</a> by Jochen Fromm
                                </li>
                            </ul>
                        </div>
                    </div>
