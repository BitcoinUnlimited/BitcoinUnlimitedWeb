            ...
            <div className='row service-wrapper-row'>
                ...
                <div className='col-sm-8'>
                    ...
                    <div id="signs" className='signatures'>
                        ...
                        <br />
                          <br />
                            1.0.1.4 {strings().signatures.statement}:<br /><br />
                            ...
                            <br/>
                            {strings().signatures.signature}:<br />GzneLblfW0nm9VCF1Nh03trgoYFtzhobVwFkAOOaNhWKNr+ip/RZKwKw6ZF0BNYw+pTqt0T9M52xO1TAzjQzmLI=
                            <br/><br/>
                            {strings().signatures.sickpig} (1LwvkQTWmotqTosgBcK8kFPCKzW2BPiE1G)<br/>
                            {strings().signatures.signature}:<br />IP1wXgv5iNHEzNGa+jzyXvf8DA80L65pspk0s2b7rcu0es+Yyu2ZmJkcheKN8aPMrzr66DsAGs0oOsU/otMWW1c=
                            <br/><br/>
                            {strings().signatures.deadalnix} (1KEaWZ7tpLF4n5xFf5bpTPff7G7uJZiDGw)<br/>
                            {strings().signatures.signature}:<br />IHCIlDiHXm2S7B0Yr2B5u8/GVuj1D9fcDCjZc33rZO1MP+vx+q7155BCXS218i5KAEvSYByLLNNyW8UL4Je3CAk=
                            <br/>                        
                          <br />
