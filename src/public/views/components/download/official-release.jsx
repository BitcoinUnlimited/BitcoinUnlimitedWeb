        ...
        return (
            <div className='row service-wrapper-row'>
                ...
                <div className='col-sm-8'>
                    ...
                    <br />
                    <h4>Windows</h4>
                    <p>64-bit: Version: 0.11.2, Dec 22, 2015: <a href='/downloads/bitcoinUnlimited-0.11.2-win64-setup.exe'> bitcoinUnlimited-0.11.2-win64-setup.exe</a> <a href='/downloads/bitcoinUnlimited-0.11.2-win64.zip'> (zip)</a></p>
                    <p>32-bit: Version: 0.11.2, Dec 22, 2015: <a href='/downloads/bitcoinUnlimited-0.11.2-win32-setup.exe'> bitcoinUnlimited-0.11.2-win32-setup.exe</a> <a href='/downloads/bitcoinUnlimited-0.11.2-win32.zip'> (zip)</a></p>
                    <br />
                    <h4>Linux</h4>
