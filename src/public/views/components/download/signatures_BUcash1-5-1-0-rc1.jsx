        ...
        return (
            <div className='pt2'>
                ...
                <br />
                    ...
                    {strings().download.signatures.signature}:<br /> HxhmLb9vUIysM9JPQa75bNUQJV4RdTlR/FtW+EJxtAJJN4HmY3Hd0G+28l0nR0etoafUPxluzmYU9AZaSUB78ZA=
                    <br/><br/>
                    ...
                    {strings().download.signatures.signature}:<br /> HwCPdN9cDHsuOKawxq1F7TZsOfYvKPw05hillYGEq9rcQ+RAMCOXae72GBzs3qshQlj8ZhAv1ZbJvP5h9YrTzrI=
                    <br/><br/>
                    <br/>
                </div>
            </div>
