...
class ReleaseNotes extends React.Component {
    render() {
        return (
            <ul>
                <li className='pb1'>
                    {strings().download.notes.releasenotes_buc_2_1_0_0} <a className='link--underline dim black' target='_blank' href='https://gitlab.com/bitcoinunlimited/BCHUnlimited/-/blob/dev/doc/release-notes/release-notes-2.1.0.0.md'>{strings().download.notes.here}</a>.
                </li>
                <li className='pb1'>
                    {strings().download.notes.releasenotes_buc_2_0_0_1} <a className='link--underline dim black' target='_blank' href='https://gitlab.com/bitcoinunlimited/BCHUnlimited/-/blob/dev/doc/release-notes/release-notes-2.0.0.1.md'>{strings().download.notes.here}</a>.
                </li>
                <li className='pb1'>
                    {strings().download.notes.releasenotes_buc_2_0_0_0} <a className='link--underline dim black' target='_blank' href='https://gitlab.com/bitcoinunlimited/BCHUnlimited/-/blob/dev/doc/release-notes/release-notes-2.0.0.0.md'>{strings().download.notes.here}</a>.
                </li>
                <li className='pb1'>
                ...
                <li className='pb1'>
                    {strings().download.notes.releasenotes_buc_1_9_1_1} <a className='link--underline dim black' target='_blank' href='https://gitlab.com/bitcoinunlimited/BCHUnlimited/-/blob/dev/doc/release-notes/release-notes-1.9.1.1.md'>{strings().download.notes.here}</a>.
                </li>
                <li className='pb1'>
                    {strings().download.notes.releasenotes_buc_1_9_1_0} <a className='link--underline dim black' target='_blank' href='https://gitlab.com/bitcoinunlimited/BCHUnlimited/-/blob/dev/doc/release-notes/release-notes-1.9.1.md'>{strings().download.notes.here}</a>.
                </li>
                <li className='pb1'>
                ...
                <li className='pb1'>
                    {strings().download.notes.releasenotes_buc_1_6_0_0} <a className='link--underline dim black' target='_blank' href='https://github.com/BitcoinUnlimited/BitcoinUnlimited/blob/dev/doc/release-notes/release-notes-bucash1.6.0.md'>{strings().download.notes.here}</a>.
                </li>
                <li className='pb1'>
                ...
                <li className='pb1'>
                    {strings().download.notes.releasenotes_buc_1_3_0_1} <a className='link--underline dim black' target='_blank' href='https://github.com/BitcoinUnlimited/BitcoinUnlimited/blob/dev/doc/release-notes/release-notes-bucash1.3.0.1.md'>{strings().download.notes.here}</a>.
                </li>
                <li className='pb1'>
