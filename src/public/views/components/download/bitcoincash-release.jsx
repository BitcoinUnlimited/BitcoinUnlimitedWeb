...
import SignaturesBitcoinCash from './signatures_bch_unlimited_1-8-0-0.jsx'

class BitcoinCashRelease extends React.Component {
    render() {
        var latestVersion = "1.8.0.0";
        return (
            <div className='lh-copy py1'>
                ...
                <p><a href="https://github.com/BitcoinUnlimited/BitcoinUnlimited/blob/dev/doc/release-notes/release-notes-1.8.0.md">Release Notes</a></p>
