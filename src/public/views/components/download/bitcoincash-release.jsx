...
import SignaturesBitcoinCash from './signatures_bch_unlimited_2-1-0-0.jsx'

class BitcoinCashRelease extends React.Component {
    render() {
        var latestVersion = "2.1.0.0";
        return (
            <div className='lh-copy py1'>
                ...
                <p><a href="https://gitlab.com/bitcoinunlimited/BCHUnlimited/-/blob/dev/doc/release-notes/release-notes-2.1.0.0.md">Release Notes</a></p>
