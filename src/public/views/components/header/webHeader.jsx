            ...
            <div className='header--web header__container--web clearfix'>
                ...
                <div className="right">
                    ...
                    <Dropdown title={<Link className='non-decorated black inline-block mx2 py2' to='/resources'>{strings().header.resources.title}</Link>}>
                        ...
                        <Link className='non-decorated black block p2' to='/voting/'>{strings().header.resources.buvweb}</Link>
                        <Link className='non-decorated black block p2' to='https://cashodes.io/'>{strings().header.resources.nodes}</Link>
                    </Dropdown>
