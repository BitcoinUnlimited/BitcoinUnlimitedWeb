                ...
                <div className='footer__container white'>
                    <div className="px2 pb1 center">
                        ...
                        <div className='left-align align-top inline-block footer__section'>
                            ...
                            <Link className='block py1 link dim' to='/resources/publicchat'>{strings().resources.publicchat.title}</Link>
                        </div>
                        ...
                        <div className='left-align align-top inline-block footer__section'>
                            ...
                            <Link className='block py1 link dim' to='/about/community'>{ strings().header.about.community }</Link>
                        </div>
