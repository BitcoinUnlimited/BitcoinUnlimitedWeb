...
const extraFieldInfo = {
    ...
    thumbnail_img: { label: 'Thumbnail Image', description: 'This image may be displayed on the public blog list area.' },
    ...
    author: { label: 'Author', placeholder: 'Author name', description: 'The author of the article. Leave this field blank to display the Publisher\'s (below) as the author.' },
    publisher: { label: 'Content Publisher', description: 'Signifies who, in addition to super administrators, has the ability to edit and delete this content.', optionName: 'displayname' },
