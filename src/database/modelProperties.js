...
const extraFieldInfo = {
    ...
    author: { label: 'Author', placeholder: 'Author name', description: 'The author of the article. Required.' },
    publisher: { label: 'Content Publisher', description: '', optionName: 'displayname' },
